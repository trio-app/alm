            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td text-align="center"><?php echo $value['recdetail_invoice']; ?></td>
                        <td text-align="center"><?php echo $value['recdetail_delivery']; ?></td>
                        <td text-align="center"><?php echo $value['recdetail_po']; ?></td>
                        <td text-align="center"><?php echo $value['recdetail_date']; ?></td>
                        <td text-align="right"><?php echo number_format($value['recdetail_price']); ?></td>
                    </tr>                    
                <?php 
                    $no++;
