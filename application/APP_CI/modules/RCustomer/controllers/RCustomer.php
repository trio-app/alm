...
class RCustomer extends CI_Controller {
	...
	public function index(){
        ...
        public function getGrid(){
            ...
            print_r($this->RRCustomer->getGrid($doc));
        }        
	...
	public function read(){
            ...
            header('Content-type: application/json');
            print_r( $this->RRCustomer->load_default($start,$limit,$filter));
	}
