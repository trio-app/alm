  Ext.define('RCustomer.view.VRCustomer', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.RCustomerGrid',
  ...
  Ext.define('RCustomer.view.VRCustomerDetail',{
                        extend: 'Ext.grid.Panel',
                        alias: 'widget.RCustomerSelectedGrid',
                        id: 'RCustomerSelectedGrid',
                        height: 250,
                 ...
                 Ext.define('RCustomer.view.FRCustomer',{
                extend: 'Ext.form.Panel',
                title: 'Report Packinglist By Customer',
                alias: 'widget.FRCustomer',
                //padding : '5',
